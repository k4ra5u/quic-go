...
// Source: github.com/k4ra5u/quic-go (interfaces: Stream)
//
// Generated by this command:
//
//	mockgen -typed -build_flags=-tags=gomock -package mockquic -destination quic/stream.go github.com/k4ra5u/quic-go Stream
//
