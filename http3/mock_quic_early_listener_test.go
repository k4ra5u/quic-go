...
// Source: github.com/k4ra5u/quic-go/http3 (interfaces: QUICEarlyListener)
//
// Generated by this command:
//
//	mockgen -typed -package http3 -destination mock_quic_early_listener_test.go github.com/k4ra5u/quic-go/http3 QUICEarlyListener
//
