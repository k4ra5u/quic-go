...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/k4ra5u/quic-go/http3)](https://pkg.go.dev/github.com/k4ra5u/quic-go/http3)
...
The `http3.RoundTripper` provides a number of configuration options, please refer to the [documentation](https://pkg.go.dev/github.com/k4ra5u/quic-go/http3#RoundTripper) for a complete list.
...
If you think that your application would benefit from higher compression efficiency, or if you're interested in contributing improvements here, please let us know in [#2424](https://github.com/k4ra5u/quic-go/issues/2424).
