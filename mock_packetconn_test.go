...
//
//	mockgen -typed -package quic -self_package github.com/k4ra5u/quic-go -self_package github.com/k4ra5u/quic-go -destination mock_packetconn_test.go net PacketConn
//
